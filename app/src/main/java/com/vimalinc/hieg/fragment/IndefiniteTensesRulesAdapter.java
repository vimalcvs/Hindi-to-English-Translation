...
public class IndefiniteTensesRulesAdapter extends ArrayAdapter<String> {
    private IndefiniteTensesRules activity;
    private List<String> friendList;
    private List<String> searchList;

    public IndefiniteTensesRulesAdapter(IndefiniteTensesRules context, int resource, List<String> objects) {
