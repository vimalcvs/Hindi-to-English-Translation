...
public class ExercisesforPracticeTestAdapter extends ArrayAdapter<String> {
    private ExercisesforPracticeTest activity;
    private List<String> friendList;
    private List<String> searchList;

    public ExercisesforPracticeTestAdapter(ExercisesforPracticeTest context, int resource, List<String> objects) {
