...
public class VerbHelpingAdapter extends ArrayAdapter<String> {
    private VerbHelping activity;
    private List<String> friendList;
    private List<String> searchList;

    public VerbHelpingAdapter(VerbHelping context, int resource, List<String> objects) {
