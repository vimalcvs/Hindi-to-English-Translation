...
public class TensesSimpleTranslationAdapter extends ArrayAdapter<String> {
    private TensesSimpleTranslation activity;
    private List<String> friendList;
    private List<String> searchList;

    public TensesSimpleTranslationAdapter(TensesSimpleTranslation context, int resource, List<String> objects) {
