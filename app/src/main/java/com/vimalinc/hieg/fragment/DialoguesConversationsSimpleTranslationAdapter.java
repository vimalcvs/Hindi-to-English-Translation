...
public class DialoguesConversationsSimpleTranslationAdapter extends ArrayAdapter<String> {
    private DialoguesConversationsSimpleTranslation activity;
    private List<String> friendList;
    private List<String> searchList;

    public DialoguesConversationsSimpleTranslationAdapter(DialoguesConversationsSimpleTranslation context, int resource, List<String> objects) {
