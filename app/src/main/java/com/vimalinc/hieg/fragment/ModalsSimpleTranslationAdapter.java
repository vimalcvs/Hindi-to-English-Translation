...
public class ModalsSimpleTranslationAdapter extends ArrayAdapter<String> {
    private ModalsSimpleTranslation activity;
    private List<String> friendList;
    private List<String> searchList;

    public ModalsSimpleTranslationAdapter(ModalsSimpleTranslation context, int resource, List<String> objects) {
