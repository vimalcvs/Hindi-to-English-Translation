...
public class QuestionsMakingSimpleTranslationAdapter extends ArrayAdapter<String> {
    private QuestionsMakingSimpleTranslation activity;
    private List<String> friendList;
    private List<String> searchList;

    public QuestionsMakingSimpleTranslationAdapter(QuestionsMakingSimpleTranslation context, int resource, List<String> objects) {
