...
public class GrammerAdapter extends ArrayAdapter<String> {
    private GrammerRules activity;
    private List<String> friendList;
    private List<String> searchList;

    public GrammerAdapter(GrammerRules context, int resource, List<String> objects) {
