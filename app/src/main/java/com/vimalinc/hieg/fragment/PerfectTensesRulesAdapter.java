...
public class PerfectTensesRulesAdapter extends ArrayAdapter<String> {
    private PerfectTensesRules activity;
    private List<String> friendList;
    private List<String> searchList;

    public PerfectTensesRulesAdapter(PerfectTensesRules context, int resource, List<String> objects) {
