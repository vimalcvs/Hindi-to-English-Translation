...
public class ContinuousTensesRulesAdapter extends ArrayAdapter<String> {
    private ContinuousTensesRules activity;
    private List<String> friendList;
    private List<String> searchList;

    public ContinuousTensesRulesAdapter(ContinuousTensesRules context, int resource, List<String> objects) {
